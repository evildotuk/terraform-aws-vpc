...
resource "aws_route_table" "public" {
  count = var.create_vpc && length(var.public-app_subnets) > 0 && length(var.public-network_subnets) > 0 ? length(var.azs) : 0 # Separate RT for each AZ
...
resource "aws_route" "public_internet_gateway" {
  count = var.create_vpc && var.create_igw && var.create_igw_rt && length(var.public-app_subnets) > 0 && length(var.public-network_subnets) > 0 ? length(var.azs) : 0
...
resource "aws_route" "public_internet_gateway_ipv6" {
  count = var.create_vpc && var.create_igw && var.enable_ipv6 && var.create_igw_rt && length(var.public-app_subnets) > 0 && length(var.public-network_subnets) > 0 ? length(var.azs) : 0
