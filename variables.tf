...
variable "create_igw_rt" {
  description = "Controls if an Internet Gateway is added to the route tables for public subnets (in our case this is useful for Network Firewall and custom RT)"
  type        = bool
  default     = true
}
